...
class TestKpiMilestoneCrud:
    def test_update_kpi_creates_event(self, client, sigao_project):
        project_id = sigao_project["id"]
        kpi_id = sigao_project["kpis"][0]["id"]
    ...
    def test_add_second_kpi(self, client, sigao_project):
        project_id = sigao_project["id"]
        resp = client.post(
    ...
    def test_get_by_external_uuid(self, client, sigao_project):
